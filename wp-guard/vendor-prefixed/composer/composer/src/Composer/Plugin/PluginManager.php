...
use Anystack\WPGuard\V001\Composer\EventDispatcher\EventSubscriberInterface;
use Anystack\WPGuard\V001\Composer\Installer\InstallerInterface;
...
use Anystack\WPGuard\V001\Composer\Plugin\Capability\Capability;
...
class PluginManager
{
    ...
    public function registerPackage(PackageInterface $package, bool $failOnMissingClasses = false, bool $isGlobalPlugin = false): void
    {
        ...
        foreach ($map['files'] as $fileIdentifier => $file) {
            ...
            \Anystack\WPGuard\V001\Composer\Autoload\composerRequire($fileIdentifier, $file);
        }
        ...
        foreach ($classes as $class) {
            ...
            if ($oldInstallerPlugin) {
                if (!is_a($class, 'Anystack\WPGuard\V001\Composer\Installer\InstallerInterface', true)) {
                ...
                if (!is_a($class, 'Anystack\WPGuard\V001\Composer\Plugin\PluginInterface', true)) {
