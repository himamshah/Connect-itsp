...
namespace Anystack\WPGuard\V001\MyCLabs\Enum\PHPUnit;
 ...
 *
 * \SebastianBergmann\Comparator\Factory::getInstance()->register(new \Anystack\WPGuard\V001\MyCLabs\Enum\PHPUnit\Comparator());
 */
