...
use Anystack\WPGuard\V001\Composer\Advisory\PartialSecurityAdvisory;
use Anystack\WPGuard\V001\Composer\Advisory\SecurityAdvisory;
...
use Anystack\WPGuard\V001\Composer\Package\Version\StabilityFilter;
use Anystack\WPGuard\V001\Composer\Json\JsonFile;
use Anystack\WPGuard\V001\Composer\Cache;
...
use Anystack\WPGuard\V001\Composer\Plugin\PostFileDownloadEvent;
use Anystack\WPGuard\V001\Composer\Semver\CompilingMatcher;
...
use Anystack\WPGuard\V001\Composer\Plugin\PreFileDownloadEvent;
...
use Anystack\WPGuard\V001\Composer\Util\Http\Response;
use Anystack\WPGuard\V001\Composer\MetadataMinifier\MetadataMinifier;
...
class ComposerRepository extends ArrayRepository implements ConfigurableRepositoryInterface, AdvisoryProviderInterface
{
    ...
    private function asyncFetchFile(string $filename, string $cacheKey, ?string $lastModifiedTime = null): PromiseInterface
    {
        ...
        if (isset($this->packagesNotFoundCache[$filename])) {
            return \Anystack\WPGuard\V001\React\Promise\resolve(['packages' => []]);
        }

        if (isset($this->freshMetadataUrls[$filename]) && $lastModifiedTime) {
            // make it look like we got a 304 response
            return \Anystack\WPGuard\V001\React\Promise\resolve(true);
        }
