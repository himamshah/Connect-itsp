...
namespace Anystack\WPGuard\V001\Composer\Autoload;

use Anystack\WPGuard\V001\Composer\ClassMapGenerator\ClassMap;
use Anystack\WPGuard\V001\Composer\ClassMapGenerator\ClassMapGenerator;
use Anystack\WPGuard\V001\Composer\Config;
use Anystack\WPGuard\V001\Composer\EventDispatcher\EventDispatcher;
use Anystack\WPGuard\V001\Composer\Filter\PlatformRequirementFilter\IgnoreAllPlatformRequirementFilter;
...
use Anystack\WPGuard\V001\Composer\Semver\Constraint\Bound;
...
use Anystack\WPGuard\V001\Composer\Util\PackageSorter;
...
class AutoloadGenerator
{
    ...
    /**
     * @return ClassMap
     * @throws \Anystack\WPGuard\V001\Seld\JsonLint\ParsingException
...
EOF;
        ...
        $classMap->addClass('Anystack\WPGuard\V001\Composer\InstalledVersions', $vendorPath . '/composer/InstalledVersions.php');
        $classMap->sort();
...
class ComposerAutoloaderInit$suffix
{
    ...
    {
        if ('Anystack\WPGuard\V001\Composer\\Autoload\\ClassLoader' === \$class) {
            require __DIR__ . '/ClassLoader.php';
        }
    }

    /**
     * @return \Anystack\WPGuard\V001\Composer\Autoload\ClassLoader
     */
...
PLATFORM_CHECK;
        ...
        self::\$loader = \$loader = new \\Anystack\\WPGuard\\V001\\Composer\\Autoload\\ClassLoader(\\dirname(__DIR__));
...
INCLUDE_PATH;
        ...
        call_user_func(\Anystack\WPGuard\V001\Composer\Autoload\ComposerStaticInit$suffix::getInitializer(\$loader));
...
REGISTER_LOADER;
        ...
        if ($useIncludeFiles) {
            $file .= <<<INCLUDE_FILES
        \$filesToLoad = \Anystack\WPGuard\V001\Composer\Autoload\ComposerStaticInit$suffix::\$files;
