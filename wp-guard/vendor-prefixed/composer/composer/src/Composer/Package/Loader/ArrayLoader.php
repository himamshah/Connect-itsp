...
class ArrayLoader implements LoaderInterface
{
    ...
    {
        if ($class !== 'Anystack\WPGuard\V001\Composer\Package\CompletePackage' && $class !== 'Anystack\WPGuard\V001\Composer\Package\RootPackage') {
    ...
    public function loadPackages(array $versions): array
    {
        ...
        foreach ($versions as $version) {
            $package = $this->createObject($version, 'Anystack\WPGuard\V001\Composer\Package\CompletePackage');
