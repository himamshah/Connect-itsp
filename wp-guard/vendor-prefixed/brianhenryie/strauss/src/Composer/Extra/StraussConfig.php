...
namespace Anystack\WPGuard\V001\BrianHenryIE\Strauss\Composer\Extra;

use Anystack\WPGuard\V001\Composer\Composer;
use Exception;
use Anystack\WPGuard\V001\JsonMapper\JsonMapperFactory;
...
class StraussConfig
{
    ...
    public function __construct(Composer $composer)
    {
        ...
        if (!is_null($configExtraSettings)) {
            ...
            $mapper->push(new \Anystack\WPGuard\V001\JsonMapper\Middleware\CaseConversion(
                \Anystack\WPGuard\V001\JsonMapper\Enums\TextNotation::UNDERSCORE(),
                \Anystack\WPGuard\V001\JsonMapper\Enums\TextNotation::CAMEL_CASE()
            ));
        ...
        if (empty($this->packages)) {
            $this->packages = array_map(function (\Anystack\WPGuard\V001\Composer\Package\Link $element) {
