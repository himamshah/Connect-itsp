...
if (PHP_VERSION_ID < 80000) {
    if (!class_exists('Anystack\WPGuard\V001\Composer\BinProxyWrapper')) {
        /**
         * @internal
         */
    ...
    if (
        ...
        || (function_exists('stream_wrapper_register') && stream_wrapper_register('phpvfscomposer', 'Anystack\WPGuard\V001\Composer\BinProxyWrapper'))
    ) {
