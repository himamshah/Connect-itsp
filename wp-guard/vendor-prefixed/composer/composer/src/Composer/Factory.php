...
use Anystack\WPGuard\V001\Composer\Config\JsonConfigSource;
use Anystack\WPGuard\V001\Composer\Json\JsonFile;
use Anystack\WPGuard\V001\Composer\IO\IOInterface;
use Anystack\WPGuard\V001\Composer\Package\Archiver;
use Anystack\WPGuard\V001\Composer\Package\Version\VersionGuesser;
...
use Anystack\WPGuard\V001\Composer\Util\Loop;
...
class Factory
{
    ...
    public function createComposer(IOInterface $io, $localConfig = null, $disablePlugins = false, ?string $cwd = null, bool $fullLoad = true, bool $disableScripts = false)
    {
        ...
        if ($fullLoad) {
            ...
            if (!class_exists('Anystack\WPGuard\V001\Composer\InstalledVersions', false) && file_exists($installedVersionsPath = $config->get('vendor-dir').'/composer/InstalledVersions.php')) {
        ...
        $package = $loader->load($localConfig, 'Anystack\WPGuard\V001\Composer\Package\RootPackage', $cwd);
