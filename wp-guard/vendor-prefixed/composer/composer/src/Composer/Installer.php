...
namespace Anystack\WPGuard\V001\Composer;

use Anystack\WPGuard\V001\Composer\Autoload\AutoloadGenerator;
use Anystack\WPGuard\V001\Composer\Console\GithubActionError;
use Anystack\WPGuard\V001\Composer\DependencyResolver\DefaultPolicy;
use Anystack\WPGuard\V001\Composer\DependencyResolver\LocalRepoTransaction;
use Anystack\WPGuard\V001\Composer\DependencyResolver\LockTransaction;
use Anystack\WPGuard\V001\Composer\DependencyResolver\Operation\UpdateOperation;
use Anystack\WPGuard\V001\Composer\DependencyResolver\Operation\InstallOperation;
use Anystack\WPGuard\V001\Composer\DependencyResolver\Operation\UninstallOperation;
use Anystack\WPGuard\V001\Composer\DependencyResolver\PoolOptimizer;
use Anystack\WPGuard\V001\Composer\DependencyResolver\Pool;
use Anystack\WPGuard\V001\Composer\DependencyResolver\Request;
use Anystack\WPGuard\V001\Composer\DependencyResolver\Solver;
use Anystack\WPGuard\V001\Composer\DependencyResolver\SolverProblemsException;
use Anystack\WPGuard\V001\Composer\DependencyResolver\PolicyInterface;
use Anystack\WPGuard\V001\Composer\Downloader\DownloadManager;
use Anystack\WPGuard\V001\Composer\Downloader\TransportException;
use Anystack\WPGuard\V001\Composer\EventDispatcher\EventDispatcher;
use Anystack\WPGuard\V001\Composer\Filter\PlatformRequirementFilter\IgnoreListPlatformRequirementFilter;
use Anystack\WPGuard\V001\Composer\Filter\PlatformRequirementFilter\PlatformRequirementFilterFactory;
use Anystack\WPGuard\V001\Composer\Filter\PlatformRequirementFilter\PlatformRequirementFilterInterface;
use Anystack\WPGuard\V001\Composer\Installer\InstallationManager;
use Anystack\WPGuard\V001\Composer\Installer\InstallerEvents;
use Anystack\WPGuard\V001\Composer\Installer\SuggestedPackagesReporter;
...
use Anystack\WPGuard\V001\Composer\Package\Loader\ArrayLoader;
use Anystack\WPGuard\V001\Composer\Package\Dumper\ArrayDumper;
use Anystack\WPGuard\V001\Composer\Package\Version\VersionParser;
use Anystack\WPGuard\V001\Composer\Package\Package;
use Anystack\WPGuard\V001\Composer\Repository\ArrayRepository;
use Anystack\WPGuard\V001\Composer\Repository\RepositorySet;
use Anystack\WPGuard\V001\Composer\Repository\CompositeRepository;
use Anystack\WPGuard\V001\Composer\Semver\Constraint\Constraint;
use Anystack\WPGuard\V001\Composer\Package\Locker;
use Anystack\WPGuard\V001\Composer\Package\RootPackageInterface;
use Anystack\WPGuard\V001\Composer\Repository\InstalledArrayRepository;
use Anystack\WPGuard\V001\Composer\Repository\InstalledRepositoryInterface;
use Anystack\WPGuard\V001\Composer\Repository\InstalledRepository;
use Anystack\WPGuard\V001\Composer\Repository\RootPackageRepository;
...
use Anystack\WPGuard\V001\Composer\Repository\RepositoryManager;
use Anystack\WPGuard\V001\Composer\Repository\LockArrayRepository;
use Anystack\WPGuard\V001\Composer\Script\ScriptEvents;
use Anystack\WPGuard\V001\Composer\Semver\Constraint\ConstraintInterface;
use Anystack\WPGuard\V001\Composer\Advisory\Auditor;
...
class Installer
{
    ...
    protected function doUpdate(InstalledRepositoryInterface $localRepo, bool $doInstall): int
    {
        ...
        } catch (\Anystack\WPGuard\V001\Seld\JsonLint\ParsingException $e) {
            if ($this->updateAllowList || $this->updateMirrors) {
        ...
        if (method_exists('Anystack\WPGuard\V001\Composer\Semver\CompilingMatcher', 'clear')) { // @phpstan-ignore-line
            \Anystack\WPGuard\V001\Composer\Semver\CompilingMatcher::clear();
        }
