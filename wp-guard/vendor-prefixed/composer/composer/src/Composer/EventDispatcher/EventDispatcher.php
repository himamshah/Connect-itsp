...
namespace Anystack\WPGuard\V001\Composer\EventDispatcher;

use Anystack\WPGuard\V001\Composer\DependencyResolver\Transaction;
use Anystack\WPGuard\V001\Composer\Installer\InstallerEvent;
use Anystack\WPGuard\V001\Composer\IO\BufferIO;
...
use Anystack\WPGuard\V001\Composer\PartialComposer;
...
use Anystack\WPGuard\V001\Composer\Script;
use Anystack\WPGuard\V001\Composer\Installer\PackageEvent;
use Anystack\WPGuard\V001\Composer\Installer\BinaryInstaller;
use Anystack\WPGuard\V001\Composer\Util\ProcessExecutor;
use Anystack\WPGuard\V001\Composer\Script\Event as ScriptEvent;
use Anystack\WPGuard\V001\Composer\Autoload\ClassLoader;
use Anystack\WPGuard\V001\Symfony\Component\Console\Application;
use Anystack\WPGuard\V001\Symfony\Component\Console\Command\Command;
use Anystack\WPGuard\V001\Symfony\Component\Console\Input\StringInput;
use Anystack\WPGuard\V001\Symfony\Component\Console\Output\ConsoleOutput;
use Anystack\WPGuard\V001\Symfony\Component\Process\PhpExecutableFinder;
use Anystack\WPGuard\V001\Symfony\Component\Process\ExecutableFinder;
        ...
        try {
            ...
            foreach ($listeners as $callable) {
                ...
                if (!is_string($callable)) {
                    ...
                    if (defined('Anystack\WPGuard\V001\Composer\Script\ScriptEvents::'.str_replace('-', '_', strtoupper($event->getName())))) {
                    ...
                    $args = implode(' ', array_map(['Anystack\WPGuard\V001\Composer\Util\ProcessExecutor', 'escape'], $event->getArguments()));
