...
class RootPackageLoader extends ArrayLoader
{
     ...
     */
    public function load(array $config, string $class = 'Anystack\WPGuard\V001\Composer\Package\RootPackage', ?string $cwd = null): BasePackage
    {
        if ($class !== 'Anystack\WPGuard\V001\Composer\Package\RootPackage') {
