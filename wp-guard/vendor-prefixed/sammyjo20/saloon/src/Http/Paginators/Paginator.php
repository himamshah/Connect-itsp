...
namespace Anystack\WPGuard\V001\Saloon\Http\Paginators;

use Generator;
use Anystack\WPGuard\V001\Saloon\Contracts\Pool;
...
use Anystack\WPGuard\V001\Saloon\Exceptions\PaginatorException;
use Anystack\WPGuard\V001\Saloon\Contracts\Paginator as PaginatorContract;
...
abstract class Paginator implements PaginatorContract
{
     ...
     *
     * @var \Anystack\WPGuard\V001\Saloon\Contracts\Response|null
     */
     ...
     * @param \Anystack\WPGuard\V001\Saloon\Contracts\Request $originalRequest
     ...
     * @param callable(\Anystack\WPGuard\V001\Saloon\Contracts\Response $response, array-key $key, \Anystack\WPGuard\V001\GuzzleHttp\Promise\PromiseInterface $poolAggregate): (void)|null $responseHandler
     ...
     *
     * @return int
     * @throws \Anystack\WPGuard\V001\Saloon\Exceptions\PaginatorException
     */
