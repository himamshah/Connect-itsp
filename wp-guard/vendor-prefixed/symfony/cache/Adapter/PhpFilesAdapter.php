...
use Anystack\WPGuard\V001\Symfony\Component\Cache\Traits\FilesystemCommonTrait;
    ...
    protected function doSave(array $values, int $lifetime): array|bool
    {
        ...
        foreach ($values as $key => $value) {
            ...
            if ($isStaticValue) {
                ...
                $value = str_replace('\Anystack\WPGuard\V001\Symfony\Component\VarExporter\Internal\\', '', $value);
                $value = "namespace Anystack\WPGuard\V001\Symfony\Component\VarExporter\Internal;\n\nreturn \$getExpiry ? {$expiry} : {$value};";
            }
