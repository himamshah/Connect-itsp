...
/**
 * @extends  \Iterator<array-key, \Anystack\WPGuard\V001\Saloon\Contracts\Response|\Anystack\WPGuard\V001\GuzzleHttp\Promise\PromiseInterface>
 */
interface Paginator extends Countable, Iterator
{
     ...
     * @param callable(Response $response, array-key $key, \Anystack\WPGuard\V001\GuzzleHttp\Promise\PromiseInterface $poolAggregate): (void)|null $responseHandler
     ...
     * @return bool
     *
     * @see \Anystack\WPGuard\V001\Saloon\Contracts\Paginator::enableRewinding()
     */
