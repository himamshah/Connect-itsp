...
namespace Anystack\WPGuard\V001\Saloon\Helpers\OAuth2;

use Closure;
use Anystack\WPGuard\V001\Saloon\Traits\Makeable;
use Anystack\WPGuard\V001\Saloon\Contracts\Request;
use Anystack\WPGuard\V001\Saloon\Exceptions\OAuthConfigValidationException;
...
class OAuthConfig
{
     ...
     *
     * @var \Closure(\Anystack\WPGuard\V001\Saloon\Contracts\Request): (void)|null
     */
     ...
     *
     * @param callable(\Anystack\WPGuard\V001\Saloon\Contracts\Request): (void) $requestModifier
     * @return $this
     */
