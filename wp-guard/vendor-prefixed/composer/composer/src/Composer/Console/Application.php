...
namespace Anystack\WPGuard\V001\Composer\Console;

use Anystack\WPGuard\V001\Composer\IO\NullIO;
use Anystack\WPGuard\V001\Composer\Util\Filesystem;
use Anystack\WPGuard\V001\Composer\Util\Platform;
use Anystack\WPGuard\V001\Composer\Util\Silencer;
use LogicException;
use RuntimeException;
use Anystack\WPGuard\V001\Seld\Signal\SignalHandler;
...
use Anystack\WPGuard\V001\Seld\JsonLint\ParsingException;
use Anystack\WPGuard\V001\Composer\Command;
...
use Anystack\WPGuard\V001\Composer\IO\ConsoleIO;
use Anystack\WPGuard\V001\Composer\Json\JsonValidationException;
use Anystack\WPGuard\V001\Composer\Util\ErrorHandler;
use Anystack\WPGuard\V001\Composer\Util\HttpDownloader;
use Anystack\WPGuard\V001\Composer\EventDispatcher\ScriptExecutionException;
use Anystack\WPGuard\V001\Composer\Exception\NoSslException;
use Anystack\WPGuard\V001\Composer\XdebugHandler\XdebugHandler;
use Anystack\WPGuard\V001\Symfony\Component\Process\Exception\ProcessTimedOutException;
...
';
    ...
    public function __construct(string $name = 'Anystack\WPGuard\V001\Composer', string $version = '')
    {
            ...
            if (is_file($file) && Filesystem::isReadable($file) && is_array($composer = json_decode(file_get_contents($file), true))) {
                if (isset($composer['scripts']) && is_array($composer['scripts'])) {
                    foreach ($composer['scripts'] as $script => $dummy) {
                        if (!defined('Anystack\WPGuard\V001\Composer\Script\ScriptEvents::'.str_replace('-', '_', strtoupper($script)))) {
                            if ($this->has($script)) {
     ...
     * @return \Anystack\WPGuard\V001\Symfony\Component\Console\Command\Command[]
     */
    ...
    private function getPluginCommands(): array
    {
        ...
        if (null !== $composer) {
            ...
            foreach ($pm->getPluginCapabilities('Anystack\WPGuard\V001\Composer\Plugin\Capability\CommandProvider', ['composer' => $composer, 'io' => $this->io]) as $capability) {
