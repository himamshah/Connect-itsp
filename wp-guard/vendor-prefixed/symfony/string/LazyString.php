 ...
 */
class LazyString implements \ANYSTACK_WP_GUARD_Stringable, \JsonSerializable
{
    ...
    public static function fromStringable(string|int|float|bool|\ANYSTACK_WP_GUARD_Stringable $value): static
    {
        if (\is_object($value)) {
    ...
    {
        return \is_string($value) || $value instanceof \ANYSTACK_WP_GUARD_Stringable || \is_scalar($value);
    }
     ...
     */
    final public static function resolve(\ANYSTACK_WP_GUARD_Stringable|string|int|float|bool $value): string
    {
        return $value;
    }
