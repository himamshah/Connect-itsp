...
use Anystack\WPGuard\V001\Composer\Downloader\FilesystemException;
...
EOT
    ...
    protected function execute(InputInterface $input, OutputInterface $output): int
    {
        ...
        class_exists('Anystack\WPGuard\V001\Composer\Util\Platform');
        class_exists('Anystack\WPGuard\V001\Composer\Downloader\FilesystemException');
