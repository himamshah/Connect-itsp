...
use Anystack\WPGuard\V001\Composer\ClassMapGenerator\FileList;
...
class ClassMapGenerator
{
    ...
    {
        $generator = new \Anystack\WPGuard\V001\Composer\ClassMapGenerator\ClassMapGenerator(['php', 'inc', 'hh']);
