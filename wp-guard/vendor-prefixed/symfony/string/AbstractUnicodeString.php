...
namespace Anystack\WPGuard\V001\Symfony\Component\String;

use Anystack\WPGuard\V001\Symfony\Component\String\Exception\ExceptionInterface;
use Anystack\WPGuard\V001\Symfony\Component\String\Exception\InvalidArgumentException;
use Anystack\WPGuard\V001\Symfony\Component\String\Exception\RuntimeException;
...
{
    public const NFC = \ANYSTACK_WP_GUARD_Normalizer::NFC;
    public const NFD = \ANYSTACK_WP_GUARD_Normalizer::NFD;
    public const NFKC = \ANYSTACK_WP_GUARD_Normalizer::NFKC;
    public const NFKD = \ANYSTACK_WP_GUARD_Normalizer::NFKD;
    ...
    public function folded(bool $compat = true): static
    {
        ...
        if (!$compat || !\defined('Normalizer::NFKC_CF')) {
            $str->string = normalizer_normalize($str->string, $compat ? \ANYSTACK_WP_GUARD_Normalizer::NFKC : \Normalizer::NFC);
            $str->string = mb_strtolower(str_replace(self::FOLD_FROM, self::FOLD_TO, $this->string), 'UTF-8');
        } else {
            $str->string = normalizer_normalize($str->string, \ANYSTACK_WP_GUARD_Normalizer::NFKC_CF);
        }
